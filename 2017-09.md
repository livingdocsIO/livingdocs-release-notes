...
Editor | Bugfix | Multiple images are inserted in the right order from the local machine | [#1663](https://github.com/upfrontIO/livingdocs-editor/pull/1663) | [#326](https://github.com/upfrontIO/livingdocs-planning/issues/326)
