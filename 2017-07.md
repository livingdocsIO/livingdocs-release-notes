...
- **planning issues**: https://github.com/upfrontIO/livingdocs-planning/issues/1258
- **pull requests**: https://github.com/upfrontIO/livingdocs-editor/pull/1606

## Editor’s font-size was changed to 14px

- **type**: improvement
- **impact**: editor’s default font-size was changed to 14px.
...
- **type**: breaking change, removal
- **impact**: this pr removes `grunt` and therefore also `grunt deploy`.
...
- **pull requests**: https://github.com/upfrontIO/livingdocs-editor/pull/1608

## Link in List Tool should not be shown while dragging

- **type**: bugfix
- **impact**: link in List Tool should not be shown while dragging
- **planning issues**: https://github.com/upfrontIO/livingdocs-planning/issues/1224
- **pull requests**: https://github.com/upfrontIO/livingdocs-editor/pull/1615

# Server -> Release 2017-07
...
- **planning issues**: https://github.com/upfrontIO/livingdocs-planning/issues/1231
...
#### Storage configuration
  ...
  ```
  - **planning issues**: https://github.com/upfrontIO/livingdocs-planning/issues/1222
  - **pull requests**: https://github.com/upfrontIO/livingdocs-server/pull/1546

## Add /designs/:name/:version/:file endpoint 
  
  - **type**: breaking change
  - **impact**: Add /designs/:name/:version/:file endpoint:
  ...
  - **pull requests**: https://github.com/upfrontIO/livingdocs-server/pull/1569

## Elasticsearch upgrade from 1.7 to 2.4

- **type**: breaking change
- **impact**: elasticsearch upgraded from 1.7 to 2.4. If you have custom indices or mappings, you will have to update them according to Elasticsearch changelog.
Some queries also need to be adapted, for instance search queries sorted by a nested field.
- **planning issues**: https://github.com/upfrontIO/livingdocs-planning/issues/1281
...
- **planning issues**: https://github.com/upfrontIO/livingdocs-planning/issues/1229, https://github.com/upfrontIO/livingdocs-planning/issues/1216
- **pull requests**: https://github.com/upfrontIO/livingdocs-framework/pull/238
