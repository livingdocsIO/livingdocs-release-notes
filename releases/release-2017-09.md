...
Server | Bugfix | Log errors instead of crashing on registration | [#commit](https://github.com/upfrontIO/livingdocs-server/commit/7b91543) | -
...
Editor | Bugfix | As an editor I would like to see if I'm working on an archived article | [#commmit](https://github.com/upfrontIO/livingdocs-editor/commit/05c9bfd91018743350acfe5f7811f55f2191285e) | [#1432](https://github.com/upfrontIO/livingdocs-planning/issues/1473)
Editor | Bugfix | Components are not shown on drag and drop | [#1680](https://github.com/upfrontIO/livingdocs-editor/pull/1680) | [#1516](https://github.com/upfrontIO/livingdocs-planning/issues/1516)
Editor | Bugfix | Uncaught TypeError: Cannot read property 'configure' of undefined | [#1689](https://github.com/upfrontIO/livingdocs-editor/pull/1689) | [#1527](https://github.com/upfrontIO/livingdocs-planning/issues/1527)
Editor | Bugfix | TypeError: Cannot read property 'rangeCount' of null | [#1678](https://github.com/upfrontIO/livingdocs-editor/pull/1678) | [#1497](https://github.com/upfrontIO/livingdocs-planning/issues/1497)
...
Framework | Bugfix | Image order on multi-upload from local machine [Read more](#image-order-on-multi-upload-from-local-machine) | [#259](https://github.com/upfrontIO/livingdocs-framework/pull/259) | [#326](https://github.com/upfrontIO/livingdocs-planning/issues/326)
